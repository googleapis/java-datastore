...
public final class CreateIndexRequest extends com.google.protobuf.GeneratedMessage
    implements
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26:
              {
                input.readMessage(internalGetIndexFieldBuilder().getBuilder(), extensionRegistry);
