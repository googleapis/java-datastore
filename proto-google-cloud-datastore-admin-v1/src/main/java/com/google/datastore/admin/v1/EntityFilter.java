...
public final class EntityFilter extends com.google.protobuf.GeneratedMessage
    implements
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    for (int i = 0; i < kinds_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, kinds_.getRaw(i));
    }
    for (int i = 0; i < namespaceIds_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, namespaceIds_.getRaw(i));
    }
