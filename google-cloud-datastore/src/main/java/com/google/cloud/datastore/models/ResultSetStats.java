 ...
 * QueryPlan and QueryStats will be present. If QueryMode.EXPLAIN was set, QueryPlan will be present and QueryStats will return null.
 */
public class ResultSetStats {
  ...
  @InternalApi
  public ResultSetStats(com.google.datastore.v1.ResultSetStats proto) {
