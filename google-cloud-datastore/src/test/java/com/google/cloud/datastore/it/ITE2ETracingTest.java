...
import static com.google.cloud.datastore.telemetry.TelemetryConstants.SPAN_NAME_ALLOCATE_IDS;
import static com.google.cloud.datastore.telemetry.TelemetryConstants.SPAN_NAME_BEGIN_TRANSACTION;
import static com.google.cloud.datastore.telemetry.TelemetryConstants.SPAN_NAME_COMMIT;
import static com.google.cloud.datastore.telemetry.TelemetryConstants.SPAN_NAME_LOOKUP;
import static com.google.cloud.datastore.telemetry.TelemetryConstants.SPAN_NAME_RESERVE_IDS;
import static com.google.cloud.datastore.telemetry.TelemetryConstants.SPAN_NAME_ROLLBACK;
import static com.google.cloud.datastore.telemetry.TelemetryConstants.SPAN_NAME_RUN_AGGREGATION_QUERY;
import static com.google.cloud.datastore.telemetry.TelemetryConstants.SPAN_NAME_RUN_QUERY;
import static com.google.cloud.datastore.telemetry.TelemetryConstants.SPAN_NAME_TRANSACTION_COMMIT;
import static com.google.cloud.datastore.telemetry.TelemetryConstants.SPAN_NAME_TRANSACTION_LOOKUP;
import static com.google.cloud.datastore.telemetry.TelemetryConstants.SPAN_NAME_TRANSACTION_RUN;
import static com.google.cloud.datastore.telemetry.TelemetryConstants.SPAN_NAME_TRANSACTION_RUN_QUERY;
