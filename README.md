...
```Groovy
implementation 'com.google.cloud:google-cloud-datastore:2.17.1'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-datastore/2.17.1
