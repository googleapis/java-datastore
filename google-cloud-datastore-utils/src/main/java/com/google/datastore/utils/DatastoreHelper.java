...
import com.google.datastore.utils.QuerySplitterImpl;
...
public final class DatastoreHelper {
    private static final Logger logger = Logger.getLogger(com.google.datastore.utils.DatastoreHelper.class.getName());
    ...
    private static final class KeyComparator implements Comparator<Key> {
        ...
        static final com.google.datastore.utils.DatastoreHelper.KeyComparator INSTANCE = new com.google.datastore.utils.DatastoreHelper.KeyComparator();
     ...
     *
     * <p>The returned {@link com.google.datastore.utils.QuerySplitter#getSplits} cannot accept a query that contains inequality
