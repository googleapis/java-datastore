          ...
          switch (tag) {
            ...
            case 18: {
              com.google.datastore.v1.Projection m =
                  input.readMessage(
                      com.google.datastore.v1.Projection.parser(),
                      extensionRegistry);
              if (projectionBuilder_ == null) {
                ensureProjectionIsMutable();
                projection_.add(m);
            ...
            case 26: {
              com.google.datastore.v1.KindExpression m =
                  input.readMessage(
                      com.google.datastore.v1.KindExpression.parser(),
                      extensionRegistry);
              if (kindBuilder_ == null) {
                ensureKindIsMutable();
                kind_.add(m);
            ...
            case 42: {
              com.google.datastore.v1.PropertyOrder m =
                  input.readMessage(
                      com.google.datastore.v1.PropertyOrder.parser(),
                      extensionRegistry);
              if (orderBuilder_ == null) {
                ensureOrderIsMutable();
                order_.add(m);
            ...
            case 50: {
              com.google.datastore.v1.PropertyReference m =
                  input.readMessage(
                      com.google.datastore.v1.PropertyReference.parser(),
                      extensionRegistry);
              if (distinctOnBuilder_ == null) {
                ensureDistinctOnIsMutable();
                distinctOn_.add(m);
