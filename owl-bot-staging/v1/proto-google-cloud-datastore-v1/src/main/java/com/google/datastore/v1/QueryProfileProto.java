...
public final class QueryProfileProto {
  ...
  static {
    ...
    internal_static_google_datastore_v1_ExplainOptions_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_datastore_v1_ExplainOptions_descriptor,
        new java.lang.String[] { "Analyze", });
    internal_static_google_datastore_v1_ExplainMetrics_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_datastore_v1_ExplainMetrics_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_datastore_v1_ExplainMetrics_descriptor,
        new java.lang.String[] { "PlanSummary", "ExecutionStats", });
    internal_static_google_datastore_v1_PlanSummary_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_datastore_v1_PlanSummary_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_datastore_v1_PlanSummary_descriptor,
        new java.lang.String[] { "IndexesUsed", });
    internal_static_google_datastore_v1_ExecutionStats_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_google_datastore_v1_ExecutionStats_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_datastore_v1_ExecutionStats_descriptor,
