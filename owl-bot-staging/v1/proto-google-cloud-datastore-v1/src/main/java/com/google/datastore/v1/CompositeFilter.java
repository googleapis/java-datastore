...
private static final long serialVersionUID = 0L;
   ...
   * @return The op.
   */
  @java.lang.Override public com.google.datastore.v1.CompositeFilter.Operator getOp() {
    com.google.datastore.v1.CompositeFilter.Operator result = com.google.datastore.v1.CompositeFilter.Operator.forNumber(op_);
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.datastore.v1.CompositeFilter result) {
      if (filtersBuilder_ == null) {
    ...
    private void buildPartial0(com.google.datastore.v1.CompositeFilter result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              com.google.datastore.v1.Filter m =
                  input.readMessage(
                      com.google.datastore.v1.Filter.parser(),
                      extensionRegistry);
              if (filtersBuilder_ == null) {
                ensureFiltersIsMutable();
                filters_.add(m);
