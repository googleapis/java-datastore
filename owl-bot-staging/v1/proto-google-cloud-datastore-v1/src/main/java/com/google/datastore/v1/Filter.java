...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    switch (filterTypeCase_) {
      case 1:
        if (!getCompositeFilter()
            .equals(other.getCompositeFilter())) return false;
        break;
      case 2:
        if (!getPropertyFilter()
            .equals(other.getPropertyFilter())) return false;
        break;
      case 0:
      default:
    }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              input.readMessage(
                  getPropertyFilterFieldBuilder().getBuilder(),
                  extensionRegistry);
              filterTypeCase_ = 2;
              break;
            } // case 18
