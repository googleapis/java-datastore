...
def generate_client(service, version, proto_path=None, bazel_target=None, package=None):
  ...
  if service == "datastore-admin":
    s.copy(library / f'gapic-google-cloud-{service}-{version}-java/src', 'google-cloud-datastore-admin/src')
    java.format_code(f'google-cloud-datastore-admin/src')
  else:
    s.copy(library / f'gapic-google-cloud-{service}-{version}-java/src', 'google-cloud-datastore/src')
    java.format_code(f'google-cloud-datastore/src')
...
admin_v1 = generate_client(
    ...
    bazel_target='//google/datastore/admin/v1:google-cloud-datastore-admin-v1-java',
    package='com.google.datastore.admin.v1',
)

datastore_v1 = generate_client(
    service='datastore',
    version='v1',
)
